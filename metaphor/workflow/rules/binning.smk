...
checkpoint DAS_tool:
    ...
    output:
        summary="output/binning/DAS_tool/{binning_group}/{binning_group}_DASTool_summary.tsv",
...
rule bins_report:
    ...
    """
    input:
        bins_eval="output/binning/DAS_tool/{binning_group}/{binning_group}_allBins.eval",
    output:
